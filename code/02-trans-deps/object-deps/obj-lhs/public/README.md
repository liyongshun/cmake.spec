...
$ cc -fPIC   -shared -Wl,-soname,libbar.so -o libbar.so build/bar/src/bar.c.o 
```
...
$ cc    build/main/main.c.o build/foo/src/foo.c.o  -o build/mian/main  -Wl,-rpath,build/bar build/bar/libbar.so
```